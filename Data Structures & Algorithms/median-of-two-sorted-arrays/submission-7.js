class Solution {
    ...
    findMedianSortedArrays(nums1, nums2) {
        ...
        while(loop) {
            ...
            remainingItemsLength = medianLength - leftPartition.length;
            rightPartition = largerArray.slice(0, remainingItemsLength + 1);

            console.log(`left : ${leftPartition} right ${rightPartition}`);

            if(
                (leftPartition[leftPartition.length - 1] < largerArray[remainingItemsLength + 2]) &&
            ...
            count++;
            if(count > 10) {
                console.log("count exceeded max");
                return;
            }
        }
